...
namespace YAMBOLY.GESTIONACTIVOSFIJOS.USERMODEL._MSS_CFPE
{
    ...
    /// </summary>
    [DBStructure]
    [SAPTable(TableDescription = "AF- Conf. Permisos", TableType = SAPbobsCOM.BoUTBTableType.bott_MasterData)]
    public class MSS_CFPE
    {
        ...
        [SAPField(FieldDescription = "Codigo usuario")]
        public string MSS_COUS { get; set; }

        [SAPField(FieldDescription = "Nombre usuario")]
        public string MSS_NOUS { get; set; }

        [SAPField(FieldDescription = "Codigo almacen")]
