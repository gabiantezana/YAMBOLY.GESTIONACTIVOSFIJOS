...
namespace YAMBOLY.GESTIONACTIVOSFIJOS.USERMODEL._MSS_CFSE
{
    ...
    public class MSS_CFSE
    {
        ...
        [SAPField(FieldDescription = "Serie SAP Entrega", FormattedSearchType = typeof(MSS_GESTION_ACTIVOS_FIJOS.MSS_FS_LISTAR_SERIES_ENTREGA))]
        public static string U_MSS_SEEN { get; set; }

        [SAPField(FieldDescription = "Serie SAP Devolucion", FormattedSearchType = typeof(MSS_GESTION_ACTIVOS_FIJOS.MSS_FS_LISTAR_SERIES_DEVOLUCION))]
        ...
        [SAPField(FieldDescription = "Codigo de almacen", FormattedSearchType = typeof(MSS_GESTION_ACTIVOS_FIJOS.MSS_FS_LISTAR_ALMACENES))]
